...
문제 
 ...
 1년이 지날 때 마다, 세 수는 모두 1씩 증가한다. 
 만약, 어떤 수가 범위를 넘어가는 경우에는 1이된다.
 
 예를 들어, 15년은 15 15 15로 나타낼 수 있다. 
 하지만, 1년이 지나서 16년이 되면 16 16 16이 아니라 1 16 16이된다.

 E, S, M이 주어졌고 1년이 준규가 사는 나라에서 E S M이 우리가 알소 있는 연도로 몇 년인지 구하는 프로그램을 작성하여라
